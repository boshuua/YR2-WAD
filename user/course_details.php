...
$duration_formatted = '';
if ($interval->d > 0)
    $duration_formatted .= $interval->d . ' days, ';
if ($interval->h > 0)
    $duration_formatted .= $interval->h . ' hours, ';
if ($interval->i > 0)
    $duration_formatted .= $interval->i . ' minutes';
        ...
        <main class="app-main">
            ...
            <div class="app-content">
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <?php if ($course['trainer_id']): ?>
                            <p><strong>Trainer:</strong>
                                <?php echo htmlspecialchars($course['first_name'] . ' ' . $course['last_name']); ?></p>
                        <?php endif; ?>

                        <p><strong>Spaces Available:</strong>
                            <?php echo $course['enrolled_count'] . ' of ' . $course['max_attendees'] . ' booked'; ?></p>
                    ...
                    $is_past = new DateTime($course['end_date']) < new DateTime(); // Check if the end_date is in the past
                    if ($is_past) {
                        echo '<button class="btn" disabled>Course Complete</button>';
