    ...
    <div class="app-container">
        ...
        <main class="app-main">
            ...
            <div class="app-content">
                <?php display_breadcrumbs(['/admin/dashboard' => 'Dashboard', '#' => 'Manage Courses']); ?>
                <a href="/admin/course_add.php" class="btn" style="width: auto; margin-bottom: 20px;">Add New Course</a>
                <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($course['series_id']): ?>
                                            <a href="/admin/view_series.php?series_id=<?php echo $course['series_id']; ?>">View Series</a> |
                                        <?php endif; ?>
                                        <a href="/admin/course_edit.php?id=<?php echo $course['id']; ?>">Edit First</a> |
