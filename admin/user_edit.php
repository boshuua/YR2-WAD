...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_id_to_edit == $_SESSION['user_id'] && $access_level != 'admin') {
        ...
        $success = "User updated successfully! <a href='/admin/users'>Back to list</a>";
    }
}
...
<body>
    <div class="app-container">
        ...
        <main class="app-main">
            <header class="app-header"><h1>Edit User</h1></header>
            <div class="app-content">
                <?php display_breadcrumbs([
                    '/admin/dashboard' => 'Dashboard',
                    '/admin/users' => 'Manage Users',
                    '#' => 'Edit: ' . htmlspecialchars($user['first_name'] . ' ' . $user['last_name'])
                ]); ?>
                <div class="card">
