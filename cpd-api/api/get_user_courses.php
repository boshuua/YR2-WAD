...
$query = "SELECT 
          ...
          WHERE c.status = 'published' -- Only show published courses to users
...
if ($num > 0) {
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $course_item = array(
            ...
            "user_progress_status" => $user_progress_status ?? 'not_started', // Default if no progress entry
    ...
    echo json_encode(array("message" => "No published courses found."));
}
